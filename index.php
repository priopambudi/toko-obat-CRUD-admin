<?php
 ...
 if($_SESSION['status_user'] != "konsumen"){
     echo '<meta http-equiv="refresh" content="0; URL=../sitobat/nologin/nologin.php">';
  }
?>
...
#batas{
    ...
    <ul>
        <div class="batas">
            ...
            <li><a href="../sitobat/keranjang/keranjang.php">Keranjang</a></li>
            <!-- <li><a href="../sitobat/invoice/invoice.php">Invoice</a></li> -->
            <div id="batas">
                ...
                <form action="../sitobat/aksi_beli.php" method="POST" class="w-50">
                    <div class="py-2">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="namapembeli" autocomplete="off" class="form-control" id="inlineFormInputGroup" placeholder="Nama Pembeli">
                        </div>
                    </div>
                    ...
                    <div class="py-2">
                        <input type="submit" name="insert" value="Beli Obat">
                    </div>
                </form>
            </div>
        </div>
