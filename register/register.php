...
body{
    ...
    <br> <br>
	<h1> Belum punya akun ya? Daftar dulu kuy </h1>
	<div class="kotak_login">
		<p class="tulisan_login"> Daftar dulu skuy </p>
        <form action="../register/aksi_register.php" method="POST">
            ...
            <input type="text" name="no_telp" autocomplete="off" class="form-control" id="inlineFormInputGroup" placeholder="No Telepon">
            <!-- <button type="submit" name="marilogin" class="btn tombol_login"> Login </button> -->
            <br>
            <center>
            <input type="submit" name="marilogin" value="Daftar">
            </center>
        ...
        <center>
        <label  for="ckb1">
			<centre>Sudah Punya Akun? Klik <b><a href="../login/login.php"> Di sini </a></b></centre>
        </label>
        </center>
