...
#batas{
    ...
    <table style="width:50%;">
        ...
        <td><a href="edit_keranjang.php?namapembeli=<?php echo $row['namapembeli'] . "&nama_obat=" . $row['nama_obat'] . "&jmlh_obat=" . $row['jmlh_obat'] . "&id_keranjang=" . $row['id_keranjang'] ?>">Edit</a></td>
    ...
    <!-- <a href="../sitobat/invoice/invoice.php">Invoice</a> -->
